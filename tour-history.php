...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Lịch sử chuyến tham quan của tôi</h3>
		<form name="chngpwd" method="post" onSubmit="return valid();">
		 <?php if($error){?><div class="errorWrap"><strong>LỖI</strong>:<?php echo htmlentities($error); ?> </div><?php } 
				else if($msg){?><div class="succWrap"><strong>THÀNH CÔNG</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
	<p>
	<table border="1" width="100%">
		<tr style="background-color: #d7ddd7;">
			<th>STT</th>
			<th>Đặt chỗ</th>
			<th>Tên gói</th>	
			<th>Từ</th>
...
<?php if($result->status==2)
{
	?><td>Đã hủy</td>
<?php } else {?>
<td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy đặt phòng không')" >Thoát</a></td>
<?php }?>
</tr>
<?php $cnt=$cnt+1; }} ?>
	</table>
