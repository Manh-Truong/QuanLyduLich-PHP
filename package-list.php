...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Danh sách gói</h1>
	</div>
</div>
<!--- /banner ---->
<!--- rooms ---->
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					...
					<a href="package-details.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view">Chi tết</a>
				</div>
