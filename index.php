...
<div class="banner">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> GROUP 6 - Hệ thống quản lý du lịch</h1>
	</div>
</div>
...
<div class="container">
	<div class="rupes">
		...
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			...
			<div class="rup-rgt">
				<h3>GIẢM ĐẾN 70</h3>
				<h4><a href="offers.html">TRÊN THẾ GIỚI</a></h4>
...
<div><a href="package-list.php" class="view">Xem thêm các gói</a></div>
</div>
			<div class="clearfix"></div>
	</div>
