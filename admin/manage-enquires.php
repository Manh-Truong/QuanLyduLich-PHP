...
{				?>		
						  <tr>
							...
							<td width="400"><?php echo htmlentities($result->Description);?></td>
								...
								<td width="180"><?php echo htmlentities($result->PostingDate);?></td>
...
<td>
	<a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có thực sự muốn đọc')" >Chưa giải quyết</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
