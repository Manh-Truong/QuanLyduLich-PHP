...
<html>
<head>
<title>Quản trị viên quản lý đặt chỗ</title>
...
{				?>		
						  <tr>
							<td>#AD<?php echo htmlentities($result->bookid);?></td>
...
<?php if($result->status==2)
{
	?><td>Đã hủy</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy đặt phòng không')" >Hủy bỏ</a>  <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn xác nhận')" >Xác nhận</a></td>
<?php }?>
