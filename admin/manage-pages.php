...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Trang chủ</a><i class="fa fa-angle-right"></i>Cập nhật dữ liệu trang </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="grid-form1">
  	       <h3>Cập nhật dữ liệu trang</h3>
  	         ...
  	         <div class="tab-content">
                  ...
                  <option value="manage-pages.php?type=Điều khoản sử dụng">Điều khoản sử dụng</option>
                  <option value="manage-pages.php?type=Chính sách bảo mật">Chính sách bảo mật</option>
                  <option value="manage-pages.php?type=Giới thiệu">Giới thiệu</option> 
                  <option value="manage-pages.php?type=Liên hệ">Liên hệ</option>
                </select>
									</div>
								</div>
<div class="form-group">
			...
			switch($_GET['type'])
			{
				...
				case "privacy" :
									echo "Chính sách và quyền riêng tư";
									break;
		...
		$(document).ready(function() {
			 ...
			 $(window).scroll(function(){
				...
				if(scrollpos >=navoffeset){
					$(".header-main").addClass(" Đã sửa");
				}else{
					$(".header-main").removeClass(" Đã sửa");
				}
			 });
