...
<html>
<head>
<title>Quản trị viên quản lý sự cố</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý sự cố</li>
            </ol>
...
{				?>		
						  <tr>
							...
							<td width="400"><?php echo htmlentities($result->Description);?></td>
								...
								<td width="250"><?php echo htmlentities($result->PostingDate);?></td>
